        ...
        return (
            <>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4 bg-gray-100 rounded-lg shadow-lg">
                    ...
                    <Group className="z-20 flex items-center justify-center gap-2">
                        {SWATCHES.map((swatch) => (
                            <ColorSwatch key={swatch} color={swatch} onClick={() => setColor(swatch)} className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full cursor-pointer hover:opacity-75 transition-opacity duration-150" />
                        ))}
                    </Group>
